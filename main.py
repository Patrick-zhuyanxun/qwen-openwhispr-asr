...
app.add_middleware(
    CORSMiddleware,
    allow_origin_regex=r"^(http://127\.0\.0\.1:\d+|http://localhost:\d+|file://.*|app://.*)$",
...
def _model_entry(model_id: str, display_name: str | None = None, owned_by: str = "qwen"):
...
def models():
    ...
    data = [_model_entry(model_id, "Qwen3-ASR")]
